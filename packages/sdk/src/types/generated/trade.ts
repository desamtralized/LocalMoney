 ...
 */
export type Trade = {
  "address": "5fRDb9S3Z61fBALmDHNV5EH7GDP8gsCGkQT8eawDL1kE",
  "metadata": {
    "name": "trade",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "LocalMoney Trade Program - Core P2P exchange logic"
  },
  "instructions": [
    {
      "name": "acceptTrade",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "buyerProfile",
          "docs": [
            "Buyer's profile (for counter update if expired)"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "escrowVault",
          "docs": [
            "Escrow vault token account (PDA-controlled ATA)"
          ],
          "writable": true
        },
        {
  ...
  "errors": [
    ...
    {
      "code": 6024,
      "name": "fiatCurrencyMismatch",
      "msg": "Fiat currency mismatch"
    },
    {
      "code": 6025,
      "name": "arbitratorNotAssigned",
      "msg": "Arbitrator not assigned"
    },
    {
      "code": 6026,
      "name": "onlyAssignedArbitrator",
