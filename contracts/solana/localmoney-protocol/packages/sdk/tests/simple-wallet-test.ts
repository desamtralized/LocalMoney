...
async function runSimpleTest() {
  try {
    ...
    try {
      ...
      const sdk = LocalMoneySDK.createWithKeypair(
        connection,
        keypair,
        {
          hub: new (await import('@solana/web3.js')).PublicKey('J5FDxQmMpiF4vqKBSWQS3JRGLyE8djRgoHF8QQJJKWM1'),
          profile: new (await import('@solana/web3.js')).PublicKey('6HJHAiMENmYh4wW99YtHVY6tGDTzdrNeMtwSpDiyGu1k'),
          price: new (await import('@solana/web3.js')).PublicKey('7nkFUfmqKMKrQfm83HxreJHXyJdTK5feYqDEJtNihaw1'),
          offer: new (await import('@solana/web3.js')).PublicKey('DGjiY2hKsDpffEgBckNfrAkDt6B5jSxwsHshyQ1cRiP9'),
          trade: new (await import('@solana/web3.js')).PublicKey('AxX94noi3AvotjdqnRin3YpKgbQ1rGqQhjkkxpeGUfnM'),
          arbitration: new (await import('@solana/web3.js')).PublicKey('3XkiY4D1FBnpKHpuT2pi3AhnZ2WcXXGSsR4vSYJ87RbR'),
        }
      );
