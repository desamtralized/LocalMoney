...
async function main() {
    ...
    try {
        ...
        // 6. Deploy Trade Contract FIRST before ArbitratorManager
        ...
        // 7. NOW Deploy ArbitratorManager with Trade address
        ...
        const arbitratorManager = await upgrades.deployProxy(
            ArbitratorManager, 
            [hubAddress, tradeAddress], // Now we have tradeAddress!
            {
                initializer: "initialize",
                kind: "uups"
            }
        ...
        // 8. Update Hub Configuration with all deployed contracts
